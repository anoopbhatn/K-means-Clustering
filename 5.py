...
# Verification
def verify(l1,l2,l3,c1,c2,c3):
	s=0
	for i in l1:
		s+=distance(i,c1)*distance(i,c1)
	for i in l2:
		s+=distance(i,c2)*distance(i,c2)
	for i in l3:
		s+=distance(i,c3)*distance(i,c3)
	print s
